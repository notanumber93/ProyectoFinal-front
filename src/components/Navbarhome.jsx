        ...
        <ul className="navbar-nav mr-auto">
          ...
          <li className="nav-item dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="navbarDropdown">
              <Link className="dropdown-item" to="/">Mejores rankeadas</Link>
              <Link className="dropdown-item" to="/">Peores rankeadas</Link>
              <div className="dropdown-divider"></div>
              <Link className="dropdown-item" to="/">Top Ten</Link>
            </div>
          </li>
        </ul>
        <form className="form-inline my-2 my-lg-0" />
        <input className="form-control mr-sm-2" defaultValue={props.searchValue} onChange={(event) => props.handledChange(event)} placeholder="Search" aria-label="Search" />
